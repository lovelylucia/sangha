...
<div class="register">
    ...
    <section id="fregister_term">
        ...
        <fieldset class="fregister_agree">
            ...
            <label for="agree11"><span></span><strong>위 회원 가입 약관의 내용에 동의 합니다.<em>(필수)</em></strong></label>
        </fieldset>
    </section>
    ...
    <section id="fregister_private">
        ...
        <fieldset class="fregister_agree">
            ...
            <label for="agree21"><span></span><strong>개인 정보 처리 방침 안내의 내용에 동의 합니다.<em>(필수)</em></strong></label>
       </fieldset>
    </section>
    ...
    <div class="btn_confirm">
    	<a href="../../index.html" class="btn_close">취소</a>
