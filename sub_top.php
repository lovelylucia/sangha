                ...
                <div class="navi_container">
                    <ul class="depth1">
                        ...
                        <li>
                            ...
                            <ul class="depth2">
                                <li>
                                    <a href="http://sanghacasuwon.or.kr/g5/bbs/board.php?bo_table=notice">공지사항</a>
                                </li>
                                <li>
                                    <a href="http://sanghacasuwon.or.kr/g5/bbs/board.php?bo_table=weekly">본당주보</a>
                                </li>
                                <li>
                                    <a href="http://sanghacasuwon.or.kr/g5/bbs/board.php?bo_table=gallery">갤러리</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="depth2">
                                <li>
                                    <a href="sub0401.html">미사 및 성사시간</a>
                                </li>
                                <li>
                                    <a href="http://sanghacasuwon.or.kr/g5/bbs/board.php?bo_table=homily">신부님 강론</a>
                                </li>
                                <li>
                                    <a href="sub0403.html">예비자교리안내</a>
                                </li>
                                <li>
                                    <a href="http://maria.catholic.or.kr/mi_pr/missa/missa.asp">매일미사</a>
                                </li>
                                <li>
                                    <a href="http://maria.catholic.or.kr/mi_pr/prayer/prayer.asp?menu=prayer&pgubun=&ingId=">주요기도문</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="depth2">
                                <li>
                                    <a href="http://sanghacasuwon.or.kr/g5/bbs/board.php?bo_table=free">자유게시판</a>
                                </li>
                                <li>
                                    <a href="http://sanghacasuwon.or.kr/g5/bbs/board.php?bo_table=reference">자료실</a>
                                </li>
                                <li>
                                    <a href="http://sanghacasuwon.or.kr/g5/bbs/board.php?bo_table=companion">교우업체소개</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
